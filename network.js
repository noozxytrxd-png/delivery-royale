...
function createHostRoom() {
    ...
    peer.on('open', (id) => {
        ...
        players = {};
        players[myId] = { id: myId, x: 0, z: 3, rotY: 0, score: 0, profile: getMyProfile() };
...
function broadcastWorldState() {
    if (!isHost) return;
    const state = { type: 'WORLD_STATE', players, packageHolderId, pkgPos: { x: packageMesh.position.x, y: packageMesh.position.y, z: packageMesh.position.z }, housePos: houseGroup.position, gameTime: gameTimeSeconds };
